...
router.post("/login", async (req, res) => {
    ...
    try {
        ...
        let userInfo = { id: user.id, email: user.email, name: user.name, roles: user.roles };
...
router.get("/auth", validateToken, (req, res) => {
    let userInfo = { id: req.user.id, email: req.user.email, name: req.user.name, roles: req.user.roles };
