...
function SignUpStep2() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      const emailParams = {
        name: `${values.salutation} ${values.fullName}`,
        event_name: "Go Green! Volunteer Program",
        event_date: "2024-08-15", // Example static date
        event_time: "10:00 AM",
        event_location: "123 Green Street, City",
        email: values.email,
        phone: values.phone,
      ...
      // Optionally, you can still log the form values or send them to your server
      console.log(values);
    },
  });
  ...
  return (
    <Box sx={{ p: 4 }}>
      <Button component={Link} to={`/announcement-signup-step1/${id}`}>
        &lt;&lt; Back
      </Button>
