        ...
        >
          ...
          >
            <Typography
              ...
              sx={{
                flexGrow: 1,
                wordBreak: "break-word", // Forces wrapping on long words
                whiteSpace: "normal", // Allows wrapping within the container
                overflow: "hidden",
          ...
          <Typography
            ...
            sx={{
              ...
              overflow: "hidden",
              textOverflow: "ellipsis",
              maxHeight: "4.5em", // Limit the height to 3 lines (1.5em per line)
              lineHeight: "1.5em", // Line height corresponding to font size
            }}
          >
            {feature.description}
          </Typography>
